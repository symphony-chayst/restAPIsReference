...
Released prior to 1.43. Authenticates the API caller on the key manager using the client certificate provided in the TLS session, returning a key manager token.
